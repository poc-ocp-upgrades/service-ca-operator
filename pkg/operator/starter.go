...
func RunOperator(ctx *controllercmd.ControllerContext) error {
	...
	v1helpers.EnsureOperatorConfigExists(dynamicClient, v4_00_assets.MustAsset("v4.0.0/service-ca-operator/operator-config.yaml"), operatorv1.GroupVersion.WithResource("servicecas"))
