...
func setDegradedFalse(operatorConfig *operatorv1.ServiceCA, reason string) {
	_logClusterCodePath()
	defer _logClusterCodePath()
	v1helpers.SetOperatorCondition(&operatorConfig.Status.Conditions, operatorv1.OperatorCondition{Type: operatorv1.OperatorStatusTypeDegraded, Status: operatorv1.ConditionFalse, Reason: reason})
}
